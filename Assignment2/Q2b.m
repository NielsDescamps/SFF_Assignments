...
% num_points = 100;
% save_fig = true;
% file_name = ['MVTplot_df_exact',num2str(df),'_Loc',num2str(Mu(1)),num2str(Mu(2)),'_Sig',num2str(Sigma(1,2)),'_'];
% plotMVTLocationScaleExact(Mu,Sigma, df, dims, num_points,save_fig,file_name);
